...
const tileState = {
  ...
  // nullLoc is the position of the gap, again numbers 0 through 8.
  tileLoc: {},
  nullLoc: '',
};
...
function gameSetup() {
  ...
  img.src = "https://cdn.glitch.me/322c0444-bdb6-400c-8c7b-568c71c6bd72%2Fm.jpg?v=16371733903455";
...
function moveTile(tileId, tileLoc, nullLoc) {
  ...
  const moveX = `calc(${direction[0] * -100}% + ${direction[0] * -5}px)`;
...
function findAdjacencyDirection(tileLoc, nullLoc) {
  ...
  */
  if (tileLoc - nullLoc === 5) {
    ...
    return [1, 0];
  } else if (tileLoc - nullLoc === -1 && tileLoc % 5 !== 4) {
    return [-1, 0];
  } else return null;
}
