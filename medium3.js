// link: https://glitch.com/edit/#!/sliding-photo-puzzle
...
function gameSetup() {
  const gameArea = document.getElementById('game-area-medium');
  const img = new Image();
  ...
  img.onload = function() {
    ...
    const tiles = [...Array(16)].map((_) => tileHTML); // The array is 16 because we want a 4 by 4 puzzle for the medium game
